...
consists of choosing two adjacent and equal letters, and 
removing them.
...
since the letters are adjacent and equal, and this 
is the only possible move.  The result of this 
move is that the string is "aaca", of which only 
